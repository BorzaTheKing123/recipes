...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/samoborzatta/Herd/recipes/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/samoborzatta/Herd/recipes/public/storage','logging.default','logging.deprecations.channel',
...
'session.secure','session.http_only','session.same_site','session.partitioned','two-factor.cache.store',
'two-factor.cache.prefix','two-factor.recovery.enabled','two-factor.recovery.codes','two-factor.recovery.length','two-factor.safe_devices.enabled',
'two-factor.safe_devices.cookie','two-factor.safe_devices.max_devices','two-factor.safe_devices.expiration_days','two-factor.confirm.key','two-factor.confirm.time',
'two-factor.login.view','two-factor.login.key','two-factor.login.flash','two-factor.secret_length','two-factor.issuer',
'two-factor.totp.digits','two-factor.totp.seconds','two-factor.totp.window','two-factor.totp.algorithm','two-factor.qr_code.size',
'two-factor.qr_code.margin','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.argon.memory',
...
'tinker.alias','tinker.dont_alias',);
        ...
        registerArgumentsSet('routes', 'profile.security','two-factor.enable','two-factor.disable',
'two-factor.generate-recovery-codes','two-factor.challenge','login','edit',);
        registerArgumentsSet('views', 
'Components.button','Components.form-button','Components.form-error','Components.form-field','Components.form-input',
'Components.form-label','Components.form-select','Components.layout','Components.nav-link','auth.login',
'auth.profile','auth.register','contact','home','mail.recipe-posted',
'pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui','pagination::simple-bootstrap-4',
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','recipes.create',
'recipes.edit','recipes.index','recipes.show','results','two-factor::confirm',
'two-factor::layout','two-factor::login','two-factor::notice','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5',
...
'vendor.pagination.simple-tailwind','vendor.pagination.tailwind','vendor.two-factor.confirm','vendor.two-factor.layout','vendor.two-factor.login',
'vendor.two-factor.notice','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'pagination::tailwind','two-factor::confirm','two-factor::layout','two-factor::login','two-factor::notice',);
...
'validation.uuid','validation.custom.attribute-name.rule-name','messages.0','two-factor::messages.title','two-factor::messages.required',
'two-factor::messages.back','two-factor::messages.continue','two-factor::messages.enable','two-factor::messages.success','two-factor::messages.fail_confirm',
'two-factor::messages.enabled','two-factor::messages.disabled','two-factor::messages.safe_device','two-factor::messages.confirm','two-factor::messages.switch_on',
'two-factor::messages.recovery_code.used','two-factor::messages.recovery_code.depleted','two-factor::messages.recovery_code.generated','two-factor::validation.totp_code',);
